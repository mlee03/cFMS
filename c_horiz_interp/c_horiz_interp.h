...
extern void cFMS_get_interp_cfloat(int *ilon_ptr, int *ilon_shape, int *jlat_ptr, int *jlat_shape, 
                                   ...
                                   int *nxgrid, int *i_src_ptr, int *i_src_shape, int *j_src_ptr, int *j_src_shape, 
                                   ...
                                   int *lon_in_shape, float *lat_in_ptr, int *lat_in_shape, float *area_frac_dst, 
                                   int *area_frac_shape, float *mask_in_ptr, int *mask_in_shape, float *max_src_dist, 
                                   bool *is_allocated, int *interp_id);
...
extern void cFMS_get_interp_cdouble(int *ilon_ptr, int *ilon_shape, int *jlat_ptr, int *jlat_shape, 
                                   ...
                                   int *lon_in_shape, double *lat_in_ptr, int *lat_in_shape, double *area_frac_dst, 
                                   int *area_frac_shape, double *mask_in_ptr, int *mask_in_shape, double *max_src_dist, 
                                   bool *is_allocated, int *interp_id);
